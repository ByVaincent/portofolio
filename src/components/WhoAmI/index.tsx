  ...
  return (
    <Section classSup="w-full" id="whoami" ref={ref}>
      ...
      <p>
        ...
        React training program, which I personally financed through a loan and
        completed with Le Réacteur. Impressed by my dedication and abilities,
        the team at Liv-n later entrusted me with the frontend mobile
