    ...
    <Section classSup="" id="whoami" ref={ref}>
      <div className="flex justify-between items-center flex-wrap">
        ...
        <p className="mt-5">
          ...
          basics, I joined Le Réacteur (RNCP level 6) for a full-time training
          program I personally financed. Since then, I’ve been thriving in the
          tech world — building interfaces, solving problems, creating
          components, and improving user experience every day.
        </p>
        <p className="mt-5">
